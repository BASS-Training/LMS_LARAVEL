                        ...
                        <div class="lg:w-1/4 space-y-8">
                            ...
                            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <button type="button" @click="addElement('@{{training_date_range}}')" class="w-full text-left toolbox-element px-3 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 rounded">Tanggal Pelatihan</button>
